---
title: "Hono + OpenAPI + Orvalを使った型安全な開発"
emoji: "🎄"
type: "tech"
...
:::message
この記事は[ambr, Inc. Advent Calendar 2025](https://adventar.org/calendars/11923)の12/21の記事です。
昨日は[hoshino](https://zenn.dev/921starfish)さんの[Claude・Codex・CopilotによるPRレビュー](https://zenn.dev/ambr_inc/articles/2847d09f632bc0)でした。
:::
...
```mermaid
flowchart TB
  backend["backend(Hono + OpenAPI)"] -- "OpenAPI Spec生成" --> openapi["openapi.json"]
  openapi -- "Orvalでコード生成" --> packages-api["@packages/api"]
```
